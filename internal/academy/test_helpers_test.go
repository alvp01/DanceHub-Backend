...
func setupAcademyTestDeps(t *testing.T) (*Repository, *Service, *jwtpkg.Manager) {
	t.Helper()

	t.Setenv("JWT_ACCESS_SECRET", "academy-test-access-secret")
	t.Setenv("JWT_REFRESH_SECRET", "academy-test-refresh-secret")
	...
	if err := db.AutoMigrate(&Academy{}, &RefreshToken{}); err != nil {
